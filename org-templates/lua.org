...
#+LATEX_HEADER: \usepackage[margin=1.01in]{geometry} % margin
...
#+LATEX_HEADER: \babelfont[japanese]{rm}{HaranoAjiMincho}
#+LATEX_HEADER: \babelfont[japanese]{sf}{HaranoAjiGothic}
#+LATEX_HEADER: \babelfont[japanese]{tt}{HaranoAjiGothic}

#+LATEX_HEADER: \setmonofont[Scale=MatchLowercase]{Aporetic Serif}

#+LATEX_HEADER: \usepackage{svg}                % for svg images my need \usepackage[inkscapelatex=false]{svg}
#+LATEX_HEADER: \usepackage{float}              % for float \begin{figure}[H]

#+LATEX_HEADER: \usepackage[dvipsnames]{xcolor} % \usepackage{xcolor}   % for coddes
