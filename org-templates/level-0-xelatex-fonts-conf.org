...
#+LATEX_HEADER:     otherkeywords = {use\-package, \:hook, \:custom, \:map, \:bind, \:config, \:ensure, \:after, add\-to\-list, defcustom, defun, lambda, interactive},           
#+LATEX_HEADER:     comment=[l]{;},
#+LATEX_HEADER:     commentstyle=\color{Gray}\ttfamily,
#+LATEX_HEADER:     stringstyle=\color{ForestGreen}\ttfamily,
#+LATEX_HEADER:     morestring=[b]",
...
#+LATEX_HEADER: \setmainfont{Linux Libertine O}                %\setmainfont{Iosevka Etoile Light}
#+LATEX_HEADER: %\setmainfont{Iosevka Etoile Light}
#+LATEX_HEADER: %\setmainfont{Iosevka Aile Light}
#+LATEX_HEADER: \setmonofont{Iosevka Term SS06}  %\setmonofont{DejaVu Sans Condensed}
