...
(use-package repeat
  :straight nil
  :hook 
  (after-init-hook . repeat-mode) ;; (after-init-hook . repeat-mode)
  )
#+end_src
...
(use-package display-line-numbers
  ...
  ;; :hook
  ;; (after-init-hook . (lambda ()
  ;;                      (evil-global-set-key 'normal (kbd "SPC s l n") 'display-line-numbers-mode)
  ;;                      (evil-global-set-key 'normal (kbd "SPC s l N") 'global-display-line-numbers-mode)
  ;;                      ))
  )
#+end_src
...
(use-package org
  ...
  (after-init-hook . (lambda ()
                       ...
                       ;; (evil-define-key 'normal org-mode-map (kbd   ) #')
                       ;; (evil-define-key 'normal org-mode-map (kbd   ) #')
