...
(defun gry/distraction-free-on ()
  ...
  (cond
   ((font-available-p "Iosevka Aile"   ) (set-face-attribute 'default nil :font "Iosevka Aile"    :height 140))
   ((font-available-p "Liberation Sans") (set-face-attribute 'default nil :font "Liberation Sans" :height 140))
   ((font-available-p "Courier New"    ) (set-face-attribute 'default nil :font "Courier New"     :height 140))
   ((font-available-p "Terminus"       ) (set-face-attribute 'default nil :font "Terminus"        :height 140))
   ((font-available-p "M+ 1p medium"   ) (set-face-attribute 'default nil :font "M+ 1p medium"    :height 140))
   )

  ;; (set-face-attribute 'fixed-pitch nil :font "Iosevka Term SS06")
  )
...
(defun gry/distraction-free-off ()
  ...
  (cond
   ((font-available-p "Iosevka Term SS06") (set-face-attribute 'default nil :font "Iosevka Term SS06" :height 120))
   ((font-available-p "Iosevka"          ) (set-face-attribute 'default nil :font "Iosevka"           :height 120))
   ))
#+end_src
* Keybinding
** Which-key
