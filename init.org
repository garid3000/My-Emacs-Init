...
(use-package org
  ...
  ;; (add-hook 'org-after-refile-insert-hook 'org-mode-restart)
  )
#+end_src
...
#+RESULTS:
: #[nil ((code-cells-forward-cell) (insert "
: # %%
: 
: ") (previous-line)) nil nil nil nil]
...
** TODO =elec-pair=: auto parenthesis pair [/]
...
- [ ] abbrev-mode not working with after-init-hook hook?
...
(use-package abbrev
  ...
  :hook
  (after-init-hook . abbrev-mode) ;; (setq-default abbrev-mode t)
  (org-mode-hook   . abbrev-mode) ;; (setq-default abbrev-mode t)       
  )
#+end_src
...
;; also needed to change nix config:
