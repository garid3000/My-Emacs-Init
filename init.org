...
#+end_src
** org-roam (custom) functions for tag searching                             :customFunc:
#+begin_src emacs-lisp
...
(use-package org-agenda
  ...
  (org-agenda-custom-commands
   '(("i" "Inbox"                tags-todo "+TODO=\"TODO\"" ((org-agenda-files (file-expand-wildcards "~/BrainDump/gtd/inbox.org"))))
...
#+end_src
** TODO Website from org-roam directory
...
| =oit=    | =org-toggle-inline-images=              | [ t ] toggle shot/hide image       | org  |        |
|--------+---------------------------------------+------------------------------------+------+--------|
...
:header-args+: :var tbl_03=tbl-global-general-keybindings-org-roam-related
:header-args+: :var tbl_04=tbl-kbind-zconvenients
...
:header-args+: :var tbl_11=tbl-kbind-buffer-related
:header-args+: :var tbl_12=tbl-kbind-dev
:header-args+: :var tbl_13=tbl-global-general-keybindings-org-tbl-related
:header-args+: :var tbl_14=tbl-orgmode-general-keybindings-freq
:header-args+: :var tbl_15=tbl-orgmode-general-keybindings-todo
:header-args+: :var tbl_16=tbl-orgmode-general-keybindings-find
:header-args+: :var tbl_17=tbl-orgmode-general-keybindings-export
:header-args+: :var tbl_18=tbl-orgmode-general-keybindings-link
:header-args+: :var tbl_19=tbl-orgmode-general-keybindings-img
:END:
#+caption: converting
...
(garids-keybind/for-all-modes
  ...
  "ruim" '(org-roam-ui-mode :which-key "[ uim ] roam mode ui-in-browser")
  "ruio" '(org-roam-ui-open :which-key "[ uio ] roam open ui-in-browser")
  "ruil" '(org-roam-node-local :which-key "[ uil ] roam local ui-in-browser")
  "rf" '(my/org-roam-find-node-by-focus-tag :which-key "[ f ] find focus")
  "rF" '(consult-org-roam-file-find :which-key "[ f ] find full find")
  "rl" '(org-roam-buffer-toggle :which-key "[ l ] toggle")
  "rL" '(org-roam-buffer-display-dedicated :which-key "[ L ] dedicated")
  "ri" '(org-roam-node-insert :which-key "[ i ] insert")
  "rI" '(garid-custom/org-roam-node-insert-immediate :which-key "[ I ] insert-immediate")
  "rt" '(:ignore t :which-key "< t > tag............................")
  "rta" '(org-roam-tag-add :which-key "[ a ] add")
  "rtr" '(org-roam-tag-remove :which-key "[ r ] remove")
  "rj" '(:ignore t :which-key "< j > journal........................")
  "rjc" '(org-roam-dailies-capture-today :which-key "[ c ] capture")
  "rjr" '(org-roam-dailies-goto-today :which-key "[ t ] today")
  "rjt" '(org-roam-dailies-goto-tomorrow :which-key "[ T ] Tomorrow")
  "rjy" '(org-roam-dailies-goto-yesterday :which-key "[ y ] yesterday")
  "rjd" '(org-roam-dailies-goto-date :which-key "[ d ] date  goto date")
  "rj>" '(org-roam-dailies-goto-next-note :which-key "[ > ] next")
  "rj<" '(org-roam-dailies-goto-previous-note :which-key "[ < ] prev")
  "rd" '((lambda () (interactive) (dired org-roam-directory) ) :which-key "[ d ] dired")
  "rc" '(:ignore t :which-key "< c > consults.......................")
  "rcb" '(consult-org-roam-backlinks :which-key "[ b ] backlink")
  "rs" '(consult-org-roam-search :which-key "[ s ] search")
  "rcf" '(consult-org-roam-forwardlink :which-key "[ o ] wardlink")
  "rcF" '(consult-org-roam-find-file :which-key "[ r ]c-Find")
...
(garids-keybind/in-org-mode
  ...
  "oit" '(org-toggle-inline-images :which-key "[ t ] toggle shot/hide image")
