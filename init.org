...
(use-package org-gtd
  ...
  (:map evil-normal-state-map
        ...
        ("SPC o g c" . 'org-gtd-clarify-item          )
        )
...
(use-package eshell-atuin
  ...
  ;; :bind (:map eshell-mode-map ("C-r" .  'eshell-atuin-history))  ;; <-- don't know why it's not working
  )
#+end_src
...
#+RESULTS:
: #s(hash-table data (:use-package (27202 9863 837322 595000) :use-package-secs (0 0 9037 285000) :init (27202 9863 837252 595000) :config (27202 9863 837244 860000) :config-secs (0 0 1 633000) :init-secs (0 0 11 102000)))
