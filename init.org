...
(use-package evil-collection
  ...
  ;; maybe use;
  ;; bm calc calendar comint compile consult corfu (csv
  ;; "csv-mode") diff-hl diff-mode ediff eglot flycheck flymake gptel
  ;; grep ibufferr (magit magit-submodule) magit-repos magit-section
  ;; magit-todos notmuch pass (pdf pdf-view) python rg ripgrep
  ...
  ;; mu4e-conversation neotree newsticker nov omnisharp org-present
...
*** TODO =edraw= SVG drawing inline in org
#+begin_src emacs-lisp
(use-package edraw-mode
  ...
  :after org
  :demand t  ;; needed <== don't know why (dont know why :config not running )
  :custom
