...
| =osa=  | =(org-archive-subtree-default-with-confirmation)= | a.rchive                      | org  | y      |
| =osY=  | =org-id-copy=                                     | Y.ank (ID)                    | org  |        |
| =osv=  | =org-mark-element=                                | v.isually select element      | org  |        |
| =osm=  | =org-refile=                                      | m.ove/refile                  | org  |        |
...
(garids-keybind/in-org-mode
  ...
  "osa" '((lambda () (interactive) (org-archive-subtree-default-with-confirmation) ) :which-key "a.rchive")
  "osY" '(org-id-copy :which-key "Y.ank (ID)")
  "osv" '(org-mark-element :which-key "v.isually select element")
  "osm" '(org-refile :which-key "m.ove/refile")
