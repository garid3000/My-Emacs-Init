...
(use-package delight
  ...
  (delight '(
             ...
             (python-mode                       "🐍 "                  )
             (python-ts-mode                    "🐍 "                  )
             (org-roam-mode                     "🎠 "  org-roam        ) ;; minor modes
             (which-key-mode                    "🎹 "  which-key       )
             (git-gutter-mode                   "👁️ "  git-gutter      )
             (org-auto-tangle-mode              "🔽 "  org-auto-tangle )
             (auto-revert-mode                  "🔃 "  autorevert      )
             (org-indent-mode                   "👉 "  org             )
             (org-src-mode                      "🐴 "  org             )
             (yas-minor-mode                    "🔜 "  yasnippet       )
             (evil-collection-unimpaired-mode   "😈 "  evil-collection )
             (eldoc-mode                        "📚 "  eldoc           )
             (magit-status-mode                 "🪄 "  magit           )
             (lisp-interaction-mode             "💋 " elisp-mode      )
