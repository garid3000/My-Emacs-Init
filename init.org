...
(use-package evil-collection
  ...
  ;; diff-hl diff-mode ediff eglot flycheck flymake  grep
  ;; ibufferr notmuch pass (pdf pdf-view) python rg ripgrep
...
(use-package edraw-mode
  ...
  :hook
  (after-init                 . edraw-org-setup-default)
  (after-init                 . edraw-org-setup-exporter)
  (edraw-property-editor-mode . turn-off-evil-mode))
...
(use-package eshell-atuin
  ...
  :hook (after-init . eshell-atuin-mode)) ;; why this not working
#+end_src
...
(setq notmuch-mua-compose-in 'new-frame) ;; nice
(setq notmuch-address-command 'internal) ;;
(setq notmuch-address-use-company nil) ;; probably must (perhaps C-M-i is enough?)
...
(setq notmuch-show-part-button-default-action 'notmuch-show-view-part) ;; interesting
