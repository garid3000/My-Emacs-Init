...
(setq tbl_all_kbind (seq-filter (lambda (x) (string= (nth 4 x) ""))    tblall))
(setq tbl_org_kbind (seq-filter (lambda (x) (string= (nth 4 x) "org")) tblall))
