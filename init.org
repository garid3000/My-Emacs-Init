...
(use-package which-key
  ...
  (which-key-side-window-max-width  .5)
...
Global = can be called from everywhere (doesn't matter what file-type you're currently on).

**** (from anywhere) most frequent keybinding
#+attr_latex: :placement [H]
#+caption: frequently used cmds
#+name: tbl-global-general-keybindings-freq
...
**** (from anywhere) buffer related
#+attr_latex: :placement [H]
#+caption: buffer
#+name: tbl-global-general-keybindings-buffer
| key(s) | lambda | function                    | short description  |
|--------+--------+-----------------------------+--------------------|
...
**** (from anywhere) org related
#+attr_latex: :placement [H]
#+caption: Org related (from everywhere i.e. doesn't care in-or-out of org-file)
...
**** (from anywhere) org-roam related
#+attr_latex: :placement [H]
#+caption: Org-Roam related (from everywhere i.e. doesn't care in-or-out of org-file)
...
**** (from anywhere) convenient stuffs
#+attr_latex: :placement [H]
#+caption: convenient stuffs
#+name: tbl-global-general-keybindings-convenient
| key(s) | lambda | function                               | short description   |
|--------+--------+----------------------------------------+---------------------|
| z      |        | :ignore t                              | (z)conveniences+... |
| za     |        | garid-custom/align-regexp-and-untabify | align               |
| zr     |        | replace-regexp                         | replace word in buf |
...
**** (from anywhere) system releted
#+attr_latex: :placement [H]
#+caption: system
#+name: tbl-global-general-keybindings-system
| key(s) | lambda | function                                                | short description          |
|--------+--------+---------------------------------------------------------+----------------------------|
| s      |        | :ignore t                                               | (s)ys...................   |
| srf    | y      | (recentf-open-files)                                    | s-(r)ecent-(f)iles         |
| sl     |        | :ignore t                                               | s-(l)ine................   |
| sl5    | y      | (setq display-line-numbers-width 5)                     | sl-(5) digit number        |
| sl4    | y      | (setq display-line-numbers-width 4)                     | sl-(4) digit number        |
| sl3    | y      | (setq display-line-numbers-width 3)                     | sl-(3) digit number        |
...
| scl    | y      | (global-command-log-mode) (clm/open-command-log-buffer) | s-(c)md-(l)og              |
| sw     |        | whitespace-mode                                         | s-(w)hitespace             |
| O      |        | :ignore t                                               | (O)pen+.................   |
| Oe     | y      | (find-file "~/.config/emacs/init.org")                  | O-(e)macs confg org        |
| OE     | y      | (find-file "~/.config/emacs/init.el")                   | O-(E)macs confg el         |
| Ob     | y      | (find-file (nth 0 org-cite-global-bibliography))        | O-(b)ibliography           |
| OO     | y      | (find-file org-default-notes-file)                      | O-(O)rg capture            |
...
**** (from anywhere) help related
#+attr_latex: :placement [H]
#+caption: help for emacs/elisp related
#+name: tbl-global-general-keybindings-help
| key(s) | lambda | function        | short description       |
|--------+--------+-----------------+-------------------------|
| h      |        | :ignore t       | (h)elp+...              |
...
**** (from anywhere) bookmark related
#+attr_latex: :placement [H]
#+caption: bookmark
#+name: tbl-global-general-keybindings-bookmark
| key(s) | lambda | function         | short description |
|--------+--------+------------------+-------------------|
...
#+attr_latex: :placement [H]
#+caption: misc.
#+name: tbl-global-general-keybindings-misc
| key(s) | lambda | function     | short description |
|--------+--------+--------------+-------------------|
...
**** (from anywhere) project related
#+attr_latex: :placement [H]
#+caption: project (project is defined by git repo)
...
| RD     | y      | (dired denote-directory) | R-(D)ired         |

**** (from anywhere) yas-snippet releted
#+attr_latex: :placement [H]
...
*** Sequential inside-org-file keybindings
Inside-org-file = called only in org-file (won't be called from different file-type).

**** (in org-file) frequent
#+attr_latex: :placement [H]
...
| os     |        | :ignore t                    | o-(s)ubtree+...            |
| osy    |        | org-copy-subtree             | os-(y)ank (aka copy)       |
| osY    |        | org-id-copy                  | os-(Y)ank (ID)             |
| osv    |        | org-mark-subtree             | os-(v)isually select       |
| osd    |        | org-cut-subtree              | os-(d)elete (aka cut)      |
| ost    |        | org-toggle-narrow-to-subtree | os-(t)oggle narrow         |
| osn    |        | org-num-mode                 | os-(n)um mode              |
| osi    |        | org-indent-mode              | os-(i)ndent mode           |
| oss    |        | org-sort                     | os-(s)ort                  |
| osp    |        | org-set-property             | os-(p)roperty              |

**** (in org-file) todo related
#+attr_latex: :placement [H]
#+caption: settings TODO of current heading (in org-file)
...
| oas    |        | org-schedule                                    | oa-(s)chedule     |
| oad    |        | org-deadline                                    | oa-(d)eadline     |

**** (in org-file) find
#+attr_latex: :placement [H]
#+caption: finding stuffs in current org-file
...
**** (in org-file) export
#+attr_latex: :placement [H]
#+caption: export current org-file (latex/html) + preview
#+name: tbl-orgmode-general-keybindings-export
| key(s) | lambda | function                         | short description      |
|--------+--------+----------------------------------+------------------------|
| ox     |        | :ignore t                        | o-(x)port+...          |
...
**** (in org-file) org insert citation and footnotes
...
:PROPERTIES:
:header-args:  :var tbl_all_kbind_00=tbl-global-general-keybindings-freq
:header-args+: :var tbl_all_kbind_01=tbl-global-general-keybindings-org-mode-related
:header-args+: :var tbl_all_kbind_02=tbl-global-general-keybindings-org-roam-related
:header-args+: :var tbl_all_kbind_03=tbl-global-general-keybindings-convenient
:header-args+: :var tbl_all_kbind_04=tbl-global-general-keybindings-yassnippet
:header-args+: :var tbl_all_kbind_05=tbl-global-general-keybindings-system
:header-args+: :var tbl_all_kbind_06=tbl-global-general-keybindings-denote
:header-args+: :var tbl_all_kbind_07=tbl-global-general-keybindings-help
:header-args+: :var tbl_all_kbind_08=tbl-global-general-keybindings-project
:header-args+: :var tbl_all_kbind_09=tbl-global-general-keybindings-bookmark
:header-args+: :var tbl_all_kbind_10=tbl-global-general-keybindings-consult
:header-args+: :var tbl_all_kbind_11=tbl-global-general-keybindings-calc
:header-args+: :var tbl_all_kbind_12=tbl-global-general-keybindings-buffer
:header-args+: :var tbl_all_kbind_13=tbl-global-general-keybindings-misc
:header-args+: :var tbl_org_kbind_00=tbl-orgmode-general-keybindings-freq
:header-args+: :var tbl_org_kbind_01=tbl-orgmode-general-keybindings-todo
:header-args+: :var tbl_org_kbind_02=tbl-orgmode-general-keybindings-find
:header-args+: :var tbl_org_kbind_03=tbl-orgmode-general-keybindings-export
:header-args+: :var tbl_org_kbind_04=tbl-orgmode-general-keybindings-link
:header-args+: :var tbl_org_kbind_05=tbl-orgmode-general-keybindings-img
:END:
#+caption: converting
#+name: src_that_converts_key_tables
#+begin_src elisp :wrap src emacs-lisp :tangle no
(setq tbl_all_kbind (append tbl_all_kbind_00 tbl_all_kbind_01 tbl_all_kbind_02
                            tbl_all_kbind_03 tbl_all_kbind_04 tbl_all_kbind_05
                            tbl_all_kbind_06 tbl_all_kbind_07 tbl_all_kbind_08
                            tbl_all_kbind_09 tbl_all_kbind_10 tbl_all_kbind_11
                            tbl_all_kbind_12 tbl_all_kbind_13))


(setq tbl_org_kbind (append tbl_org_kbind_00 tbl_org_kbind_01 tbl_org_kbind_02
                            tbl_org_kbind_03 tbl_org_kbind_04 tbl_org_kbind_05))
...
(garids-keybind/for-all-modes
  ...
  "zr" '(replace-regexp :which-key "replace word in buf")
...
(garids-keybind/in-org-mode
  ...
  "osv" '(org-mark-subtree :which-key "os-(v)isually select")
