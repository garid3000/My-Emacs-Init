...
| L      |        | :ignore t                                               | buffer+...             |
| Lr     |        | revert-buffer-quick                                     | (r)eread               |
| Le     |        | eval-buffer                                             | (e)val                 |
| Li     |        | ibuffer                                                 | (i)buffer              |
| Ln     |        | rename-buffer                                           | (r)ename               |
| Lp     |        | switch-to-prev-buffer                                   | jump-(p)rev            |
| LP     |        | switch-to-next-buffer                                   | jump-(P)next           |
| Ld     |        | crux-delete-file-and-buffer                             | (d)elete               |
| Lc     |        | clone-indirect-buffer                                   | (c)lone                |
| Ls     |        | crux-create-scratch-buffer                              | new-(s)cratch-buffer   |
| C      |        | :ignore t                                               | calc related           |
| Ca     |        | calc                                                    | calc                   |
| Ce     |        | calc-embedded                                           | embedded               |
| Cf     |        | full-calc                                               | full                   |
| c      |        | :ignore t                                               | consult+...            |
| mg     |        | magit-status                                            | (m)a(g)it              |
| co     |        | consult-org-heading                                     | (o)rg                  |
...
| cd     |        | consult-dir                                             | (d)ir                  |
| b      |        | :ignore t                                               | bookmark+...           |
| bm     |        | consult-bookmark                                        | book(m)ark-consult     |
| bs     |        | bookmark-set                                            | (s)et                  |
| bd     |        | bookmark-delete                                         | (d)elete               |
| br     |        | bookmark-rename                                         | (r)ename               |
| p      |        | :ignore t                                               | project+...            |
...
| v      |        | :ignore t                                               | project+...            |
| vq     |        | format-all-buffer                                       | (q)-format-buffer      |
| vr     |        | project-query-replace-regexp                            | (r)eplace              |
| e      |        | eshell                                                  | (e)shell               |
| vt     |        | vterm                                                   | (v)ir-(t)erm           |
| <      |        | recompile                                               | recompile              |
| ruim   |        | org-roam-ui-mode                                        | (r-ui)-(m)ode          |
| D      |        | :ignore t                                               | Denote+...             |
...
| soe    | y      | (find-file "~/.config/emacs/init.org")                  | open emacs confg org   |
| soE    | y      | (find-file "~/.config/emacs/init.el")                   | open emacs confg el    |
| sob    | y      | (find-file (nth 0 org-cite-global-bibliography))        | open bibliography      |
| soc    | y      | (find-file org-default-notes-file)                      | open org capture       |
| srf    | y      | (recentf-open-files)                                    | s-(r)ecent-(f)iles     |
| sl     |        | :ignore t                                               | (l)ine related         |
| sl5    | y      | (setq display-line-numbers-width 5)                     | line-num 5 digit       |
| sl4    | y      | (setq display-line-numbers-width 4)                     | line-num 4 digit       |
| sl3    | y      | (setq display-line-numbers-width 3)                     | line-num 3 digit       |
| slm    |        | scroll-lock-mode                                        | (s)croll-(l)ock-(m)ode |
...
*** convert keybinds for all modes
#+caption: adsf
#+name: convert-global-general-keybindings
#+begin_src elisp :var tab=tbl-global-general-keybindings :wrap src emacs-lisp :tangle no
(concat
 "(garids-keybind/for-all-modes\n"
 (mapconcat
  (lambda (row) (format "  \"%s\" '(%s :which-key \"%s\")"
                        (nth 0 row)
...
#+RESULTS: convert-global-general-keybindings
#+begin_src emacs-lisp
(garids-keybind/for-all-modes
  ...
  "Lr" '(revert-buffer-quick :which-key "(r)eread")
  "Le" '(eval-buffer :which-key "(e)val")
  "Li" '(ibuffer :which-key "(i)buffer")
  "Ln" '(rename-buffer :which-key "(r)ename")
  "Lp" '(switch-to-prev-buffer :which-key "jump-(p)rev")
  "LP" '(switch-to-next-buffer :which-key "jump-(P)next")
  "Ld" '(crux-delete-file-and-buffer :which-key "(d)elete")
  "Lc" '(clone-indirect-buffer :which-key "(c)lone")
  "Ls" '(crux-create-scratch-buffer :which-key "new-(s)cratch-buffer")
  "C" '(:ignore t :which-key "calc related")
  "Ca" '(calc :which-key "calc")
  "Ce" '(calc-embedded :which-key "embedded")
  "Cf" '(full-calc :which-key "full")
  "c" '(:ignore t :which-key "consult+...")
  "mg" '(magit-status :which-key "(m)a(g)it")
  "co" '(consult-org-heading :which-key "(o)rg")
  ...
  "bm" '(consult-bookmark :which-key "book(m)ark-consult")
  "bs" '(bookmark-set :which-key "(s)et")
  "bd" '(bookmark-delete :which-key "(d)elete")
  "br" '(bookmark-rename :which-key "(r)ename")
  ...
  "vr" '(project-query-replace-regexp :which-key "(r)eplace")
  ...
  "soe" '((lambda () (interactive) (find-file "~/.config/emacs/init.org") ) :which-key "open emacs confg org")
  "soE" '((lambda () (interactive) (find-file "~/.config/emacs/init.el") ) :which-key "open emacs confg el")
  "sob" '((lambda () (interactive) (find-file (nth 0 org-cite-global-bibliography)) ) :which-key "open bibliography")
  "soc" '((lambda () (interactive) (find-file org-default-notes-file) ) :which-key "open org capture")
  "srf" '((lambda () (interactive) (recentf-open-files) ) :which-key "s-(r)ecent-(f)iles")
  "sl" '(:ignore t :which-key "(l)ine related")
  "sl5" '((lambda () (interactive) (setq display-line-numbers-width 5) ) :which-key "line-num 5 digit")
  "sl4" '((lambda () (interactive) (setq display-line-numbers-width 4) ) :which-key "line-num 4 digit")
  "sl3" '((lambda () (interactive) (setq display-line-numbers-width 3) ) :which-key "line-num 3 digit")
  ...
  "y" '(:ignore t :which-key "yassnippet+...")
...
(rune/leader-keys-other
  ...
  ;;"lr"  '(revert-buffer-quick            :which-key "(l-r)evert"            )
  ;;"lw"  '(consult-buffer-other-window    :which-key "(l-w)indow"            )
  "ll"  '(consult-buffer-other-frame       :which-key "(l-f)rame"             )
  "le"  '(eval-buffer                      :which-key "(l-e)val"              )
  ;;"lb"  '(ibuffe                         :which-key "(l-b)uffer"            )
  ;;"li"  '(ibuffer                        :which-key "(l-i)buffer"           )
  "ln"  '(rename-buffer                    :which-key "(l-n)ame"              )
  "lp"  '(switch-to-prev-buffer            :which-key "(l-p)rev"              )
  "lP"  '(switch-to-next-buffer            :which-key "(l-P)next"             )
