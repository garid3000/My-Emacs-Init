...
(use-package evil
  ...
  ;; (global-set-key [mouse-3] 'evil-paste-after)
  ...
  :hook (after-init . evil-mode) ;; (evil-mode 1)
  )
#+end_src
...
(use-package wdired
  ...
  ;; almoslty no need already bind with W
  )
#+end_src
...
** =dired-filter= need to do further the keybind
#+begin_src emacs-lisp
...
(use-package embark
  ...
  :init
  (setq prefix-help-command #'embark-prefix-help-command) ;; what is this ?
  :config
...
(use-package denote
  ...
  (denote-directory ;; can be list
   (mapcar     ;; dynamically getting the list via name if it starts with "denote_"
...
(use-package citar-denote
  ...
  ;:init ;; :config (citar-denote-mode)
  :hook (after-hook . citar-denote-mode)
  )
...
(use-package org-agenda
  ...
  (org-agenda-files '("~/BrainDump/gtd/org-gtd-tasks.org"
                      ;;//"~/BrainDump/inbox.org"
                      ;;"~/BrainDump/denote/20250911T175810--personal__gtd.org"
...
(use-package org-gtd
  ...
  (setq org-gtd-directory "~/BrainDump/gtd/")
  ...
  ;; already put in the org mode config
  ...
  (("C-c d c" . org-gtd-capture)
   ...
   ("C-c C-c" . org-gtd-organize) ;; ("<f8>" . org-gtd-organize)
...
(use-package eldoc
  :straight nil
  :config
  (evil-define-key 'normal 'prog-mode-map  (kbd "K") 'eldoc) ;; this showing some questionable behaviour
  )
#+end_src
** =elixir= 
#+begin_src emacs-lisp
...
(use-package eglot
  ...
  (:states 'normal
           ...
           "g o"     'eglot-find-typeDefinition ;; (evil-define-key 'normal 'prog-mode-map  (kbd "g o") 'eglot-find-typedefinition)
           "] d"     'flymake-goto-next-error   ;; (evil-define-key 'normal 'prog-mode-map  (kbd "] d") 'flymake-goto-next-error)
           "[ d"     'flymake-goto-prev-error   ;; (evil-define-key 'normal 'prog-mode-map  (kbd "[ d") 'flymake-goto-prev-error)
           )
...
(use-package git-gutter
  ...
  :bind (:repeat-map git-gutter:repeat-map
                     ...
                     ;;("c" . magit-commit-create      ) these were great but was conflicting with 
                     ;;("C" . magit-commit             ) gptel commit keybinding.
                     ;;("b" . magit-blame              ) perhaps should have added major-mode specification for the gptel commit
                     )
  :general (
            :states 'normal
            :prefix "SPC"
  ...
  (after-init             . global-git-gutter-mode) ;; :config (global-git-gutter-mode)
...
(use-package eshell-atuin
  ...
  :hook (after-init . eshell-atuin-mode))
#+end_src
