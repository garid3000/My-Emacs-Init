...
(use-package org
  :straight (org
             :type git
             :brach "master"
             :repo "https://code.orgmode.org/bzg/org-mode.git";;            :repo "misohena/el-easydraw"
            )
  ;;:demand
  :delight " org"
  :bind (:map
...
#+end_src
** =org-num=: org number zero padding
...
(defun gry/distraction-free-on ()
  ...
  (cond
   ...
   ;;((member "Iosevka Comfy Duo"   (font-family-list)) (set-face-attribute 'default nil :font "Iosevka Comfy Duo"   :height 130))
   ;;((member "Iosevka Aile"    (font-family-list)) (set-face-attribute 'default nil :font "Iosevka Aile"    :height 200))
   ((member "Liberation Sans" (font-family-list)) (set-face-attribute 'default nil :font "Liberation Sans" :height 80))
