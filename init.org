...
(use-package org
  ...
  (org-structure-template-alist
   '(("ba" . "abstract")
     ...
     ("py" . "src python")
     ;;("tm2" . "src tmux :session tmuxSess2 :eval never-export")
     ;;("tm1" . "src tmux :session tmuxSess1 :eval never-export")
     ;;("tm" . "src tmux")
     ("do1" . "src src dot :file (concat org-download-image-dir  \"/test-dot.svg\") :exports results :eval no-export")
     ("do" . "src dot")
     ("te" . "src text")
     ("sh" . "src sh :eval no-export")
