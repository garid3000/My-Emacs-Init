...
;;(defun garid/ox-phd-publish-symbolic ()
;;  (make-symbolic-link "~/BrainDump/denote/phd/data" "~/BrainDump/denote/phd/website/data"))
;;
;; AuthType Basic
...
(use-package ox-publish
  ...
  (org-publish-project-alist `(("denote: org -> html"
                               ...
                               ("phd"
                                :base-directory "~/BrainDump/denote/phd/"
                                :recursive t
                                :publishing-function   org-html-publish-to-html
                                :publishing-directory "~/BrainDump/denote/phd/website"
                                :exclude ".*daily/.*org"  ;;; for excluding -daily
                                ;;:completion-function garid/ox-phd-publish-symbolic
                                :section-numbers  org-export-with-section-numbers
                                :with-toc         t
                                :html_link_home  "index.html"
                                :html-preamble "<style>
