...
(use-package files
  ...
  (:states 'normal
           ...
           "SPC O i"  '(lambda () (interactive)
                          (find-file "~/BrainDump/gtd/inbox.org"))
           ;; "SPC O m"  '((lambda () (interactive)
           ;; (find-file "~/BrainDump/gtd/main.org")))
           "SPC O c"  'citar-open
...
(use-package command-log-mode
  ...
  :general
  (:states 'normal
           "SPC s c l g" '((lambda () (interactive)
                           (global-command-log-mode)
                           (clm/open-command-log-buffer) )
                         :which-key "command log mode")
           "SPC s c l c"  'clm/command-log-clear
