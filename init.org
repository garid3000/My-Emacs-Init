...
(use-package evil-collection
  ...
  :hook
  (emacs-startup-hook . evil-collection-init)
...
(use-package evil-visual-mark-mode
  ...
  ;; :config
  ;; (evil-global-set-key 'normal (kbd "<f3>") 'evil-visual-mark-mode)
  :bind (:map evil-normal-state-map
...
(use-package org-gtd
  :straight t
  :after  org-edna
  ;; :demand t;;  commented on  2026-06-19
  :init
...
(use-package crux
  :straight t
  ;; :demand t  ;; demand due to :general keyword issue
  :general
  (:states 'normal
