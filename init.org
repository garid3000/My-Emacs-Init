...
(use-package delight
  ...
  (delight
   '(
     ...
     (help-mode             "❔-help "                            )
     ;; ----------  minor modes  ----------------------------------
     (dired-omit-mode       "📁-hide "  dired                     )
     (org-roam-mode         "🎠-or "    org-roam                  )
     (which-key-mode        "🎹-wk "    which-key                 )
     (git-gutter-mode       "👁️-gg "    git-gutter                )
     (org-auto-tangle-mode  "🔽-at "    org-auto-tangle           )
     (auto-revert-mode      "🔃-ar "    autorevert                )
     (org-indent-mode       "👉-in "    org-indent                )
     (org-src-mode          "🐴-os "    org                       )
     (yas-minor-mode        "🔜-ys "    yasnippet                 )
     (eldoc-mode            "📚-ed "    eldoc                     )
     (magit-status-mode     "🪄-mg "    magit                     )
     (lisp-interaction-mode "💋-el "    elisp-mode                )
     (emacs-lisp-mode       "💋-el "    elisp-mode                )
     (elpy-mode             "🐉-lpy "   elpy                      )
     (command-log-mode      "📋-log "   command-log-mode          )
     (flymake-mode          "🐤-flm "   flymake                   )
     (lsp-bridge-mode       "🌉-lsp"    lsp-bridge                )
     (evil-collection-unimpaired-mode "😈-vi "  evil-collection   )
     (all-the-icons-dired-mode     nil     all-the-icons-dired.el )
     (visual-line-mode             nil     simple                ))))
#+end_src
* M-x related (or selection method ?)
** vertico
#+begin_src emacs-lisp
(use-package vertico
  :ensure t
...
(use-package org
  ...
  (add-to-list 'org-structure-template-alist '("ba"   .  "absract"))
  (require 'org-indent)
  )
#+end_src
...
(use-package lsp-bridge
  ...
  :custom ;; (lsp-bridge-enable-profile    t)
...
| vl     | lsp-bridge-workspace-list-symbols | v-(l)ist                       | -    |        |
...
| osv    | org-mark-subtree                        | os-(v)isually select          | org  |        |
...
| ots    | (org-todo "STARTED"   )                         | ot-(s)chedule                 | org  | y      |
| otw    | (org-todo "WAITING"   )                         | ot-(w)ait                     | org  | y      |
| otd    | (org-todo "DONE"      )                         | ot-(d)one                     | org  | y      |
| otc    | (org-todo "CANCELLED" )                         | ot-(c)ancel                   | org  | y      |
| otp    | (org-todo "PROCESSED" )                         | ot-(p)rocessed                | org  | y      |
| otn    | (org-todo ""          )                         | ot-(n)one                     | org  | y      |
...
| ol>    | org-next-link                           | ol-(>)next link               | org  |        |
| ol<    | org-previous-link                       | ol-(<)prev link               | org  |        |
...
(garids-keybind/for-all-modes
  ...
  "pr" '(lsp-bridge-find-references :which-key "p-(r)eferences")
  "pd" '(lsp-bridge-diagnostic-list :which-key "p-(d)iagnostic")
  ...
  "pv" '(lsp-bridge-workspace-list-symbols :which-key "p-(v)ariables")
  "v" '(:ignore t :which-key "(📚-v)-project................")
  "vq" '(format-all-buffer :which-key "v-(q)-format-buffer")
  "vr" '(lsp-bridge-rename :which-key "v-(r)eplace")
  "vl" '(lsp-bridge-workspace-list-symbols :which-key "v-(l)ist")
