...
nn           "https://raw.githubusercontent.com/radian-software/straight.el/develop/install.el"
...
(use-package evil
  ...
  (define-key evil-normal-state-map (kbd "<f3>") 'evil-visual-mark-mode) ;; 'evil-avy-goto-char-2
  )
#+end_src
...
;;  :straight nil
;;  :hook 
;;  (after-init . (lambda () (global-font-lock-mode 1)))
;;  )
...
(use-package org
  ...
  ;;          (lambda ()
  ;;            (setq garid-orgvar-is-img-shown "This is buffer-local for Org mode.")))
...
** =denote-org=                                                                             :by_prot:
#+begin_src emacs-lisp
(use-package denote-org :straight t)
#+end_src
** =denote-silo=                                                                            :by_prot:
#+begin_src emacs-lisp
...
(use-package org-caldav
  ...
  (org-caldav-inbox        "~/BrainDump/denote_bps/20250915T233100--bps-inbox__gtd.org"         )
...
* Bunch of functions
** Open PDF/HMTL exported from org mode externally                                     :customFunc:
#+begin_src emacs-lisp
...
** Writing packages
#+begin_src emacs-lisp
;; (use-package selectric-mode       :straight t)
;; (use-package typewriter-roll-mode :straight t)
...
(use-package mw-thesaurus  :straight t :after org)
...
(garids-keybind/for-all-modes
  ...
  "ma" '(notmuch :which-key "mail nomtuch")
  "n" '(:ignore t :which-key "note........................")
  "nr" '(denote-rename-file :which-key "rename")
  "nR" '(denote-rename-file-date :which-key "rename with date")
  "nf" '(denote-open-or-create :which-key "find-or-create")
  "nd" '(denote-dired :which-key "dired-sort")
  "Nf" '(denote-silo-open-or-create :which-key "dn-silo-find")
  "Nd" '(denote-silo-dired :which-key "dn-silo-find")
  ...
  "nn" '(:ignore t :which-key "new....")
  "nnt" '(denote-type :which-key "new note, by type")
  "nnd" '(denote-date :which-key "new note, by date")
  "nns" '(denote-subdirectory :which-key "new note, by subdirectory")
  "nnt" '(denote-template :which-key "new note, by template")
  "nnS" '(denote-singature :which-key "new note, by singature")
  ...
  "Lo" '(garid/new-org-scratch :which-key "org-scratch-buffer")
  "Lp" '(garid/new-python-scratch :which-key "python-scratch-buffer")
  "Lg" '(gptel :which-key "gptel buffer")
...
** consulting notmuch
#+begin_src emacs-lisp
(use-package consult-notmuch :straight t)
#+end_src
