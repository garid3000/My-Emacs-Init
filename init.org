...
[[file:citation_styles/apa.csl][apa.csl]] style downloaded from https://citationstyles.org/, where it
is distributed under the Creative Commons Attribution-ShareAlike 3.0
license.
  ...
  (setq notmuch-saved-searches
        `(( :name "📥 inbox"
          ...
          ( :name "💬 all unread (inbox)"
            ...
            :key ,(kbd "u"))
          ( :name "💼 BPS"
            :query "tag:bps and tag:internal"
            :sort-order newest-first
            :key ,(kbd "b"))
          ( :name "🍌 esl"
