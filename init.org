...
(use-package modus-themes
  ...
  (modus-themes-headings          '((0                . (medium variable-pitch 1.15 ))
                                    (1                . (medium variable-pitch 1.10 ))
                                    (2                . (medium variable-pitch 1.05 ))
...
(use-package ox-latex
  ...
  :general
  (:states '(normal org-mode)
           "SPC x p"   'org-latex-export-to-pdf
           "SPC x P"   '((lambda () (interactive) (org-latex-export-to-pdf nil t)))
           "SPC x o"   'garid/org-open-pdf
           )
  :config
...
(use-package ox-html
  ...
  :general
  (:states '(normal org-mode)
           "SPC x h"   'org-html-export-to-html
           "SPC x H"   '((lambda () (interactive) (org-html-export-to-html nil t)) :which-key "html export subtree")
           "SPC x O"   'garid/org-open-html
           )
  )
#+end_src
...
(use-package org-re-reveal
  ...
  :general
  (:states '(normal org-mode)
           "SPC x r"   'org-re-reveal-export-to-html
           )
  )
#+end_src
...
(use-package python
  ...
  (:states '(normal inferior-python-mode)
...
(use-package harpoon
  ...
  (:states 'normal
           ...
           "SPC B 1"     'harpoon-go-to-1
           "SPC B 2"     'harpoon-go-to-2
           "SPC B 3"     'harpoon-go-to-3
           "SPC B 4"     'harpoon-go-to-4
           "SPC B 5"     'harpoon-go-to-5
           "SPC B a"     'harpoon-add-file)
  )
#+end_src
...
**** TODO org jumping around or finding things
#+attr_latex: :placement [H]
