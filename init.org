...
(use-package org
  ...
  (setq org-latex-inactive-timestamp-format  "\\textcolor{Brown}{%s}") ;; blue requires latex xcolor
  (setq org-highlight-latex-and-related '(latex script entities)) ;; native messes up with links
