...
(defun gry/distraction-free-on ()
  ...
  (cond
   ;;((font-available-p "Iosevka Aile"   ) (set-face-attribute 'org-default nil :font "Iosevka Aile" :weight 'bold :height 140))
   ((member "Iosevka Aile"    (font-family-list)) (set-face-attribute 'default nil :font "Iosevka Aile"    :height 140))
...
(defun gry/distraction-free-off ()
  ...
  (cond
   ...
   ((member "Iosevka"           (font-family-list)) (set-face-attribute 'default nil :font "Iosevka"           :height 120))
   ))
#+end_src
