...
(use-package dired
  ...
  :custom ((dired-listing-switches "-agho --group-directories-first")
           ;;(dired-listing-switches "-a --group-directories-first")
...
(use-package wdired
  ...
  (:states 'normal
           ...
           "D w"  'wdired-change-to-wdired-mode) ;; almoslty no need already bind with W
  )
#+end_src
...
(use-package emacs
  ...
  :config
  (define-key minibuffer-local-map (kbd "M-f") #'forward-word);; otherwise M-f globally bind to consult-line.
...
(use-package org
  ...
  (org-log-done            'time)
  (org-tags-column         -93) ;;-100)   ;; how many spaces left padding for tags
  (org-tag-alist           '((:startgroup . nil)
                             ("bps"  . ?b) ;; should it be like at during work time?
                             ("life" . ?l) ;; should it be more like at leasure time?
                             (:endgroup   . nil)
                             ("4bc"       . ?4)
                             ("yak"       . ?y)
                             ("tdbt"      . ?t)
...
(use-package citar
  ...
  ;; :no-require
  :custom
  (org-cite-csl-styles-dir (expand-file-name "citation_styles/" user-emacs-directory)) ;; newly added
...
(use-package org-agenda
  ...
  (org-agenda-files '(;;"~/BrainDump/denote/20250911T175810--personal__gtd.org"
                      ...
                      ;;//"~/BrainDump/inbox.org"
                      "~/BrainDump/gtd/org-gtd-tasks.org"
                      ;;//"~/BrainDump/inbox.org"
                      ))
...
(use-package eshell
  ...
  (:states 'insert
           ...
           "C-a" 'eshell-bol)
  :hook
  (eshell-mode . compilation-shell-minor-mode) ;; from compilation
  )
#+end_src
...
(use-package notmuch
  ...
  :config
  (setq notmuch-identities '("Garid <garid@bpsensing.com>"))
  (setq notmuch-fcc-dirs
        '(("garid@bpsensing.com" . "posteo/Sent")
          ))
  ...
  (setq notmuch-tree-result-format
        `(
          ("date" . "%12s  ")
          ("authors" . "%-30s") ;;(,#'my-notmuch-search-authors-field . "%s")
